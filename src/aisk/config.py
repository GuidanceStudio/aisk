...
_ALIAS_GROUPS: list[tuple[str, list[tuple[str, str]]]] = [
    ("Google Gemini", [
        ...
        ("ge35flash", "google/gemini-3.5-flash"),
...
_SHORTCUT_EXAMPLES = [("gpt", "gpt55"), ("cl", "cls46"), ("ge", "ge35flash")]
...
def _render_conf(
    ...
    *,
    ...
    lines += [
        ...
        '# Each key becomes a shell function: ds() { aisk dsv4f "$@"; }',
    ]
